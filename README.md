...
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/io.materialize/postgresql/badge.svg)](https://maven-badges.herokuapp.com/maven-central/io.materialize/postgresql)
[![Javadocs](http://javadoc.io/badge/io.materialize/postgresql.svg)](http://javadoc.io/doc/io.materialize/postgresql)
...
### Maven Central
You can search on The Central Repository with GroupId and ArtifactId [![Maven Search](https://img.shields.io/badge/io.materialize-postgresql-yellow.svg)][mvn-search] for:
...
```
[mvn-search]: http://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22io.materialize%22%20AND%20a%3A%22postgresql%22 "Search on Maven Central"
[mvn-jre6]: http://search.maven.org/#artifactdetails|io.materialize|postgresql|42.2.7.jre6|bundle
[mvn-jre7]: http://search.maven.org/#artifactdetails|io.materialize|postgresql|42.2.7.jre7|bundle
[mvn-jre8]: http://search.maven.org/#artifactdetails|io.materialize|postgresql|42.2.7|bundle
...
| Implements                          | Class                                          |
| ----------------------------------- | ---------------------------------------------- |
| java.sql.Driver                     | **io.materialize.Driver**                      |
| javax.sql.DataSource                | io.materialize.ds.PGSimpleDataSource           |
| javax.sql.ConnectionPoolDataSource  | io.materialize.ds.PGConnectionPoolDataSource   |
| javax.sql.XADataSource              | io.materialize.xa.PGXADataSource               |
