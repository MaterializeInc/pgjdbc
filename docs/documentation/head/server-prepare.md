...
for `setNull`.
Check out `io.materialize.test.jdbc2.PreparedStatementTest.testAlternatingBindType` example for more details.
...
1. You might check `io.materialize.test.jdbc2.AutoRollbackTestSuite` as it verifies lots of combinations
