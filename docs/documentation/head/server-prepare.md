...
for `setNull`.
Check out `org.materialize.test.jdbc2.PreparedStatementTest.testAlternatingBindType` example for more details.
...
1. You might check `org.materialize.test.jdbc2.AutoRollbackTestSuite` as it verifies lots of combinations
