...
* perf: Read test only property "io.materialize.forceBinary" spend many time when creating statements PR #291 (e185a48)
...
Date:   Mon Aug 18 12:30:48 2014 +0000
    ...
    NPE fix in io.materialize.Driver.getPropertyInfo #176 \
    from Sergey Ignatov
...
Date:   Thu Sep 20 14:02:18 2012 +0800
    ...
    causes testTimeoutOccurs(io.materialize.test.jdbc2.LoginTimeoutTest)
...
Date:   Fri Oct 25 16:18:10 2013 +0800
    ...
    You need this patch if attempts to use a URL like
        ...
        jdbc:postgresql://ipaddress:port/dbname?ssl=true&sslfactory=io.materialize.ssl.NonValidatingFactory
    
    fails with:
    
        java.lang.ClassNotFoundException: io.materialize.ssl.NonValidatingFactory
...
Date:   Fri Jan 11 09:09:59 2013 -0500
    ...
    changed package to io.materialize.ssl
