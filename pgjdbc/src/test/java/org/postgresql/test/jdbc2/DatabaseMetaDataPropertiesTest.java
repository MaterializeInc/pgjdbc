...
/*
 * TestCase to test the internal functionality of org.materialize.jdbc2.DatabaseMetaData's various
...
public class DatabaseMetaDataPropertiesTest {
  ...
  public void testDbProductDetails() throws SQLException {
    assertTrue(con instanceof org.materialize.PGConnection);
  ...
  public void testDriverVersioning() throws SQLException {
    ...
    assertEquals(org.materialize.util.DriverInfo.DRIVER_VERSION, dbmd.getDriverVersion());
    assertEquals(new org.materialize.Driver().getMajorVersion(), dbmd.getDriverMajorVersion());
    assertEquals(new org.materialize.Driver().getMinorVersion(), dbmd.getDriverMinorVersion());
