...
import io.materialize.util.NullOutputStream;
...
/*
 * Tests the dynamically created class io.materialize.Driver
 *
 */
public class DriverTest {
  ...
  public void testAcceptsURL() throws Exception {
    ...
    io.materialize.Driver drv = new io.materialize.Driver();
    assertNotNull(drv);
  ...
  public void testSetLogWriter() throws Exception {
    ...
    try {
      ...
      Logger logger = Logger.getLogger("io.materialize");
