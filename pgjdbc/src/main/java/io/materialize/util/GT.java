...
public class GT {
  ...
  private GT() {
    try {
      ...
      bundle = ResourceBundle.getBundle("io.materialize.translation.messages");
      //#else
      bundle = ResourceBundle.getBundle("io.materialize.translation.messages", Locale.getDefault(Locale.Category.DISPLAY));
      //#endif
