 ...
 * classes, but is useful in parsing any output from custom data types output from io.materialize.
 *
 * @see io.materialize.geometric.PGbox
 * @see io.materialize.geometric.PGcircle
 * @see io.materialize.geometric.PGlseg
 * @see io.materialize.geometric.PGpath
 * @see io.materialize.geometric.PGpoint
 * @see io.materialize.geometric.PGpolygon
 */
