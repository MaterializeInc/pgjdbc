...
import io.materialize.PGNotification;
...
import io.materialize.core.CachedQuery;
import io.materialize.core.ConnectionFactory;
import io.materialize.core.Encoding;
import io.materialize.core.Oid;
import io.materialize.core.Provider;
...
import io.materialize.core.SqlCommand;
...
import io.materialize.fastpath.Fastpath;
import io.materialize.largeobject.LargeObjectManager;
import io.materialize.replication.PGReplicationConnection;
import io.materialize.replication.PGReplicationConnectionImpl;
import io.materialize.util.GT;
import io.materialize.util.HostSpec;
import io.materialize.util.LruCache;
import io.materialize.util.PGBinaryObject;
...
public class PgConnection implements BaseConnection {
  ...
  public PgConnection(HostSpec[] hostSpecs,
    ...
    LOGGER.log(Level.FINE, io.materialize.util.DriverInfo.DRIVER_FULL_NAME);
  ...
  /*
   * This method is used internally to return an object based around io.materialize's more unique
   * data types.
   *
   * <p>It uses an internal HashMap to get the handling class. If the type is not supported, then an
   * instance of io.materialize.util.PGobject is returned.
   *
  ...
  public Object getObject(String type, String value, byte[] byteValue) throws SQLException {
    ...
    try {
      ...
      // This is used to implement the io.materialize unique types (like lseg,
      // point, etc).
  ...
  private void initObjectTypes(Properties info) throws SQLException {
    ...
    addDataType("box", io.materialize.geometric.PGbox.class);
    addDataType("circle", io.materialize.geometric.PGcircle.class);
    addDataType("line", io.materialize.geometric.PGline.class);
    addDataType("lseg", io.materialize.geometric.PGlseg.class);
    addDataType("path", io.materialize.geometric.PGpath.class);
    addDataType("point", io.materialize.geometric.PGpoint.class);
    addDataType("polygon", io.materialize.geometric.PGpolygon.class);
    addDataType("money", io.materialize.util.PGmoney.class);
    addDataType("interval", io.materialize.util.PGInterval.class);
  ...
  public Clob createClob() throws SQLException {
    checkClosed();
    throw io.materialize.Driver.notImplemented(this.getClass(), "createClob()");
  }

  @Override
  public Blob createBlob() throws SQLException {
    checkClosed();
    throw io.materialize.Driver.notImplemented(this.getClass(), "createBlob()");
  }

  @Override
  public NClob createNClob() throws SQLException {
    checkClosed();
    throw io.materialize.Driver.notImplemented(this.getClass(), "createNClob()");
  }
  ...
  public Struct createStruct(String typeName, Object[] attributes) throws SQLException {
    checkClosed();
    throw io.materialize.Driver.notImplemented(this.getClass(), "createStruct(String, Object[])");
  }
  ...
  public <T> T createQueryObject(Class<T> ifc) throws SQLException {
    checkClosed();
    throw io.materialize.Driver.notImplemented(this.getClass(), "createQueryObject(Class<T>)");
  }
