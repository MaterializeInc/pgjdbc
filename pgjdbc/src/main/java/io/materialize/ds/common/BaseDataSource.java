...
public abstract class BaseDataSource implements CommonDataSource, Referenceable {
  ...
  static {
    try {
      ...
      throw new IllegalStateException(
        "BaseDataSource is unable to load io.materialize.Driver. Please check if you have proper PostgreSQL JDBC Driver jar on the classpath",
        e);
    }
  }
  ...
  public void setUrl(String url) {
    ...
    Properties p = io.materialize.Driver.parseURL(url, null);
  ...
  public java.util.logging.Logger getParentLogger() {
    return Logger.getLogger("io.materialize");
  }
  //#endif
