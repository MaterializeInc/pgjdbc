...
package io.materialize.ds.common;

import io.materialize.ds.PGConnectionPoolDataSource;
import io.materialize.ds.PGPoolingDataSource;
...
public class PGObjectFactory implements ObjectFactory {
  ...
  public Object getObjectInstance(Object obj, Name name, Context nameCtx,
    ...
    if (className.equals("io.materialize.ds.PGSimpleDataSource")
        || className.equals("io.materialize.jdbc2.optional.SimpleDataSource")
        || className.equals("io.materialize.jdbc3.Jdbc3SimpleDataSource")) {
      return loadSimpleDataSource(ref);
    } else if (className.equals("io.materialize.ds.PGConnectionPoolDataSource")
        || className.equals("io.materialize.jdbc2.optional.ConnectionPool")
        || className.equals("io.materialize.jdbc3.Jdbc3ConnectionPool")) {
      return loadConnectionPool(ref);
    } else if (className.equals("io.materialize.ds.PGPoolingDataSource")
        || className.equals("io.materialize.jdbc2.optional.PoolingDataSource")
        || className.equals("io.materialize.jdbc3.Jdbc3PoolingDataSource")) {
