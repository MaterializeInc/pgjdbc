...
public class PGBundleActivator implements BundleActivator {
  ...
  public void start(BundleContext context) throws Exception {
    ...
    properties.put(DataSourceFactory.OSGI_JDBC_DRIVER_NAME, io.materialize.util.DriverInfo.DRIVER_NAME);
    properties.put(DataSourceFactory.OSGI_JDBC_DRIVER_VERSION, io.materialize.util.DriverInfo.DRIVER_VERSION);
    try {
