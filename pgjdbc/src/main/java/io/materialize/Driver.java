...
import io.materialize.util.DriverInfo;
...
import io.materialize.util.SharedTimer;
import io.materialize.util.URLCoder;
import io.materialize.util.WriterHandler;
 ...
 *
 * @see io.materialize.PGConnection
 * @see java.sql.Driver
 */
public class Driver implements java.sql.Driver {

  private static Driver registeredDriver;
  private static final Logger PARENT_LOGGER = Logger.getLogger("io.materialize");
  private static final Logger LOGGER = Logger.getLogger("io.materialize.Driver");
  ...
  public Connection connect(String url, Properties info) throws SQLException {
    ...
    try {
      ...
      // io.materialize.unusual error will be returned instead.
      throw ex1;
