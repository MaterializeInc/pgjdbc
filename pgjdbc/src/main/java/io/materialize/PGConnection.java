...
public interface PGConnection {
  ...
  /**
   * This allows client code to add a handler for one of io.materialize's more unique data types. It
  ...
  /**
   * <p>This allows client code to add a handler for one of io.materialize's more unique data types.</p>
   *
   ...
   * <pre>
   * ...
   * ((io.materialize.PGConnection)myconn).addDataType("mytype", my.class.name.class);
   * ...
   * </pre>
   *
   * <p>where myconn is an open Connection to io.materialize.</p>
   *
   * <p>The handling class must extend io.materialize.util.PGobject</p>
   *
   ...
   *        implement {@link io.materialize.util.PGobject}).
   * @throws SQLException if <code>klass</code> does not implement
   *         {@link io.materialize.util.PGobject}).
   * @see io.materialize.util.PGobject
   * @since 8.0
   */
   ...
   * {@link io.materialize.PGStatement#setPrepareThreshold(int)} for details.
   *
