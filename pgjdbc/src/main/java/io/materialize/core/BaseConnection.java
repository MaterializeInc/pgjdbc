...
import io.materialize.jdbc.FieldMetadata;
...
public interface BaseConnection extends PGConnection, Connection {
   ...
   * the types registered via {@link io.materialize.PGConnection#addDataType(String, Class)} and
   * {@link io.materialize.PGConnection#addDataType(String, String)}.</p>
   *
   * <p>If no class is registered as handling the given type, then a generic
   * {@link io.materialize.util.PGobject} instance is returned.</p>
   *
