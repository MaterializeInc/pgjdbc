...
import io.materialize.core.v3.TypeTransferModeRegistry;
...
public interface QueryExecutor extends TypeTransferModeRegistry {
   ...
   *        {@link io.materialize.core.Query#createParameterList()}.
   ...
   *        object returned by {@link io.materialize.core.Query#createParameterList()} created by
