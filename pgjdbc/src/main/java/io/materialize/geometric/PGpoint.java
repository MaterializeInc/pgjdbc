...
package io.materialize.geometric;
...
/**
 * <p>It maps to the point datatype in io.materialize.</p>
 *
...
public class PGpoint extends PGobject implements PGBinaryObject, Serializable, Cloneable {
  ...
  /**
   * @return the PGpoint in the syntax expected by io.materialize
   */
  ...
  /**
   * Populate the byte array with PGpoint in the binary syntax expected by io.materialize.
   */
